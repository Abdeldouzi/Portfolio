...
const techs: Tech[] = [
  ...
  { name: "GitHub Actions", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", category: "tools" },
  ...
  { name: "Stripe", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/stripe/stripe-original.svg", category: "tools" },
  ...
  { name: "PlantUML", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dot/dot-original.svg", category: "cms" },
  { name: "Excalidraw", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sketch/sketch-original.svg", category: "cms" },
  { name: "Scrum", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", category: "backend" },
  { name: "Kanban", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", category: "backend" },
  { name: "TDD", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", category: "backend" },
  { name: "API REST", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", category: "backend" },
  { name: "Microservices", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg", category: "backend" },
  { name: "JWT", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", category: "backend" },
  { name: "OWASP", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", category: "backend" },
];
