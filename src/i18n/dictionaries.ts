...
const fr = {
  ...
  skills: {
    ...
    catBackend: "Backend",
    catDatabase: "Bases de données",
    catTools: "Outils",
    catDesign: "Design & modélisation",
    catCms: "CMS",
    figmaDesc: "Maquettes UI",
    plantumlDesc: "Diagrammes UML",
    excalidrawDesc: "Schémas & wireframes",
    loopingDesc: "Modélisation Merise (MCD, MLD, MPD)",
  },
  contact: {
    title: "Contact",
    subtitle:
  ...
  game: {
    title: "Trie les compétences",
    subtitle:
      "Glisse chaque bulle dans le bon vase : **back-end**, **front-end** ou **bases de données**.",
    vaseBackend: "Back-end",
    vaseFrontend: "Front-end",
    vaseDatabase: "Bases de données",
    arenaLabel: "Compétences à classer",
    hint: "Maintiens et glisse une bulle vers un vase",
    swipeVases: "Fais glisser pour voir les autres vases",
    progress: "{n}/{total} classées",
    wrongDrop: "Pas la bonne catégorie — réessaie",
    skipQuiz: "Accéder au portfolio sans faire le jeu",
    wellDone: "Bien joué !",
    success: "Toutes les compétences sont bien classées. Ouverture du portfolio…",
  },
  blog: {
    title: "Blog",
  },
...
const en = {
  ...
  skills: {
    ...
    catTools: "Tools",
    catDesign: "Design & modeling",
    catCms: "CMS",
    figmaDesc: "UI mockups",
    plantumlDesc: "UML diagrams",
    excalidrawDesc: "Diagrams & wireframes",
    loopingDesc: "Merise modeling (CDM, LDM, PDM)",
  },
  contact: {
    title: "Contact",
    subtitle:
  ...
  game: {
    title: "Sort the skills",
    subtitle:
      "Drag each bubble into the right vase: **back-end**, **front-end** or **databases**.",
    vaseBackend: "Back-end",
    vaseFrontend: "Front-end",
    vaseDatabase: "Databases",
    arenaLabel: "Skills to sort",
    hint: "Press and drag a bubble into a vase",
    swipeVases: "Swipe to see the other vases",
    progress: "{n}/{total} sorted",
    wrongDrop: "Wrong category — try again",
    skipQuiz: "Go to the portfolio without playing",
    wellDone: "Well done!",
    success: "All skills sorted correctly. Opening the portfolio…",
  },
  blog: {
    title: "Blog",
  },
